                    ...
                    while (stop) {
                        ...
                        switch (comman) {
                            case 1:
                                ...
                                boolean b = UserService.logIn(login, password, userList1);
                                if (b == true) {
...
//---------------------------Developer--------------------------------
                                            ...
                                            case 2:
                                                ...
                                                if (q.isEmpty()) {
                                                    DeveloperService.createPerson("D:\\Desktop\\Lessons\\Lessons\\PicsArt Demo )\\src\\Base\\Developer.txt");
                                                    DeveloperService.createPerson("D:\\Desktop\\Lessons\\Lessons\\PicsArt Demo )\\src\\Base\\Developer.txt");
                                                    DeveloperService.createPerson("D:\\Desktop\\Lessons\\Lessons\\PicsArt Demo )\\src\\Base\\Developer.txt");
...
//-------------------------------------QA_Specialit--------------------------------
                                            case 3:
                                                ...
                                                if (q.isEmpty()) {
                                                    QA_SpecialistService.createPerson("D:\\Desktop\\Lessons\\Lessons\\PicsArt Demo )\\src\\Base\\QA_specialist.txt");
                                                    QA_SpecialistService.createPerson("D:\\Desktop\\Lessons\\Lessons\\PicsArt Demo )\\src\\Base\\QA_specialist.txt");
                                                    QA_SpecialistService.createPerson("D:\\Desktop\\Lessons\\Lessons\\PicsArt Demo )\\src\\Base\\QA_specialist.txt");
                                                }
...
//----------------------------------Support_Specialist-----------------------------
                                            case 4:
                                                ...
                                                if (q.isEmpty()) {
                                                    SupportService.createPerson("D:\\Desktop\\Lessons\\Lessons\\PicsArt Demo )\\src\\Base\\Support.txt");
                                                    SupportService.createPerson("D:\\Desktop\\Lessons\\Lessons\\PicsArt Demo )\\src\\Base\\Support.txt");
                                                    SupportService.createPerson("D:\\Desktop\\Lessons\\Lessons\\PicsArt Demo )\\src\\Base\\Support.txt");
